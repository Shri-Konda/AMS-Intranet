...
def index(request):    
    ...
    default_response = [
        {'increment_id': '123', 'base_currency_code': 'USD', 'grand_total': 100.0, 'created_at': '2022-01-01', 'status': 'Processing', 'purchasing_institute': 'Sample Company'},
        # Add more placeholder data as needed
    ]
    
    col_headers = list(default_response[0].keys())
